...
/// Shield class that extends Swiftcord
open class Shield: Swiftcord {
  ...
  /**
   ...
   - parameter swiftcordOptions: SwiftcordOptions structure to apply to bot
   - parameter shieldOptions: ShieldOptions structure to apply to command client
  */
  public init(
    token: String,
    swiftcordOptions: SwiftcordOptions = SwiftcordOptions(),
