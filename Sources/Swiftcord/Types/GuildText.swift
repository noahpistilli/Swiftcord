...
public class GuildText: GuildChannel, TextChannel, Updatable {
  ...
  */
  public func createWebhook(
    ...
    self.swiftcord?.createWebhook(for: self.id, with: options, then: completion)
  }
  ...
  */
  public func deleteReactions(
    ...
    guard self.type != .guildVoice else { return }
    self.swiftcord?.deleteReactions(from: messageId, in: self.id, then: completion)
  }
  ...
  public func getWebhooks(
    ...
    guard self.type != .guildVoice else { return }
    self.swiftcord?.getWebhooks(from: self.id, then: completion)
  }
